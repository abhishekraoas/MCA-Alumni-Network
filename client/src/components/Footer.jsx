        ...
        <div className="container mx-auto px-6 pt-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-20 text-left md:text-left align-items:center">
            ...
            <div>
              ...
              <p className="mb-4">
                MMMUT MCA Alumni Network, an exclusive platform that connects
                the alumni of the MCA department at Madan Mohan Malaviya
                University of Technology (MMMUT).
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-none mb-0">
                <li>
                  <a href="/helpdesk" className="text-white hover:underline">
                    Helpdesk
                  </a>
                </li>
                <li>
                  <a href="/query" className="text-white hover:underline">
                    Submit a Query
                  </a>
                </li>
                <li>
